...
export async function addEndpoint(name, url, key, authMode, transformer, model, remark, serviceTierPassthrough = false) {
    await window.go.main.App.AddEndpoint(name, url, key, authMode, transformer, model, remark || '', !!serviceTierPassthrough);
}

export async function updateEndpoint(index, name, url, key, authMode, transformer, model, remark, serviceTierPassthrough = false) {
    await window.go.main.App.UpdateEndpoint(index, name, url, key, authMode, transformer, model, remark || '', !!serviceTierPassthrough);
}
