export default {
    ...
    modal: {
        ...
        serviceTierPassthroughHelp: 'When enabled, forwards request service_tier to upstream; when disabled, removes it for provider compatibility',
        serviceTierPassthroughOff: 'Off',
        serviceTierPassthroughOn: 'On',
        cancel: 'Cancel',
        save: 'Save',
