...
func (a *App) AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, remark string, serviceTierPassthrough bool) error {
	return a.endpoint.AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, remark, serviceTierPassthrough)
}
func (a *App) RemoveEndpoint(index int) error { return a.endpoint.RemoveEndpoint(index) }
func (a *App) UpdateEndpoint(index int, name, apiUrl, apiKey, authMode, transformer, model, remark string, serviceTierPassthrough bool) error {
	return a.endpoint.UpdateEndpoint(index, name, apiUrl, apiKey, authMode, transformer, model, remark, serviceTierPassthrough)
}
